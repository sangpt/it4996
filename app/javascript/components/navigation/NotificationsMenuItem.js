...
const notifications = [
  notification(Img, 'John Smith', '3 mins ago', 'Film festivals used to be do-or-die moments for movie makers. They were where...'),
  notification(Img, 'Juan Lopez', '6 mins ago', 'Film festivals used to be do-or-die moments for movie makers. They were where...'),
  notification(Img, 'Pito Perez', '10 mins ago', 'Film festivals used to be do-or-die moments for movie makers. They were where...'),
  notification(Img, 'Juan Camaney', '1 hr ago', 'Film festivals used to be do-or-die moments for movie makers. They were where...'),
]
